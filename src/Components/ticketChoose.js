...
function TicketChoose(props) {
    ...
    return (
        <Grid
            ...
            alignItems="stretch"  sx={{ width: '835px', backgroundColor: 'white', height: 'auto', marginRight: 1, border: 0.2, borderColor: '#e5e5e5', borderRadius: 2, marginTop: 1, borderRight: 5, borderRightColor: '#FDB714', ...(props.suggest === false && {borderRightColor : 'white'}) }}>
            ...
            >
                ...
                <Button sx={{ marginTop: 1 }} variant="ticket" href='/passengers' >انتخاب بلیط</Button>

                {props.seat < 10 ? <Typography sx={{ color: '#DC3444', marginTop: 2, fontSize: '11px' }}>{props.seat} صندلی باقی مانده</Typography> : null}
